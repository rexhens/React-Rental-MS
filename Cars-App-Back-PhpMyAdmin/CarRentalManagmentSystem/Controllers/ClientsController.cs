...
namespace CarRentalManagmentSystem.Controllers
{
    ...
    public class ClientsController : ControllerBase
    {
        ...
        public IActionResult AddNewClient([FromBody]Client clientReq)
        {
            ...
            {
                var client_no_mail = new Client { PersonalNumber = clientReq.PersonalNumber, DriversLicenseNo = clientReq.DriversLicenseNo, Name = clientReq.Name, Surname = clientReq.Surname, PhoneNum = clientReq.PhoneNum };
                _context.Clients.Add(client_no_mail);
                _context.SaveChanges();
                return Ok(client_no_mail);

            }
            var client = new Client { PersonalNumber = clientReq.PersonalNumber, DriversLicenseNo = clientReq.DriversLicenseNo, Name = clientReq.Name, Surname = clientReq.Surname, PhoneNum = clientReq.PhoneNum, Email = clientReq.Email };
